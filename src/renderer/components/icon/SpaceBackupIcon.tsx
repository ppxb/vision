export const SpaceBackupIcon = props => (
  <svg
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M16 13.882C16 15.052 14.977 16 13.714 16h-4C8.768 16 8 15.289 8 14.412c0-.877.768-1.589 1.714-1.589c.114 0 .225.01.332.03a1.975 1.975 0 0 1-.141-.735c0-1.17 1.023-2.118 2.286-2.118c1.175 0 2.144.823 2.271 1.88c.895.288 1.538 1.075 1.538 2.002"
      opacity=".5"
    />
  </svg>
)
